...
sed -i 's|api "pkg/api"|api "github.com/armadaproject/armada/pkg/api"|g'  pkg/api/lookout/*.pb.go
sed -i 's|api "pkg/api"|api "github.com/armadaproject/armada/pkg/api"|g'  pkg/api/binoculars/*.pb.go
